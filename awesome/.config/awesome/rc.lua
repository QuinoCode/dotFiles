...
beautiful.font = "Hack Nerd Font 20"
beautiful.wallpaper = awful.util.get_configuration_dir() .. "./themes/FondoCuervoVentana.jpg"
--transparency:
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the wibox a.k.a the status bar
...
globalkeys = gears.table.join(
    ...
    -- Telegram
    awful.key({ modkey },            "t",     function () awful.spawn.with_shell("cd ~/Desktop/Apps && ./Telegram") end,
    ...
    -- MPDFeditor
    awful.key({ modkey },            "p",     function () awful.util.spawn("masterpdfeditor4") end,
